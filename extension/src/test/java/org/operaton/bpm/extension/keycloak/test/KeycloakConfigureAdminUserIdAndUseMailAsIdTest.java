 ...
 * Use Keycloak internal ID as administratorUserId and flag useEmailAsOperatonUserId enabled.
 */
	    ...
	    return new TestSetup(new TestSuite(KeycloakConfigureAdminUserIdAndUseMailAsIdTest.class)) {
	        ...
	        protected void setUp() throws Exception {
	    		ProcessEngineConfigurationImpl config = (ProcessEngineConfigurationImpl) ProcessEngineConfiguration
	    				.createProcessEngineConfigurationFromResource("operaton.configureAdminUserIdAndUseMailAsId.cfg.xml");
